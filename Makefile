# This Makefile is for the vcfParse extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/vcfParse.pm]
...
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/vcfParse.pm]
#     clean => { FILES=>q[vcfParse-*] }
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /Users/Nick_curie/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
MAKEMAKER   = /Users/Nick_curie/perl5/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 7.24
MM_REVISION = 72400
...
manifypods : pure_all config  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) -u \
	  lib/vcfParse.pm $(INST_MAN3DIR)/vcfParse.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: vcfParse' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "vcfParse",' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="vcfParse" VERSION="0.04">' > vcfParse.ppd
	...
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="darwin-thread-multi-2level-5.18" />' >> vcfParse.ppd
	$(NOECHO) $(ECHO) '        <CODEBASE HREF="" />' >> vcfParse.ppd
	$(NOECHO) $(ECHO) '    </IMPLEMENTATION>' >> vcfParse.ppd
	$(NOECHO) $(ECHO) '</SOFTPKG>' >> vcfParse.ppd
